...
# from lib.datasets.dataset_factory import 
...
def KpsToGrasppose(net_output, rgb_img, depth_map,  M_BL, cameraMatrix, visualize=True):
    ...
    if visualize:
        ...
        cv2.imwrite('j_8.png',rgb_img)

    # return [center_3d[0], center_3d[1], center_3d[2], orientation, dist]

def run(opt,  img, depth):
    Dataset = dataset_factory['jac_coco_36']
    opt = opts().update_dataset_info_and_set_heads(opt, Dataset)
    # print(opt)
    Detector = detector_factory['dbmctdet']
    ...
    for i in range(1):
        ...
        KpsToGrasppose(ret, img, depth,  M_BL, cameraMatrix, visualize=True)
...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/yusheng/cornell/08/pcd0860r.png')
    depth = cv2.imread('/home/yusheng/cornell/08/pcd0860d.tiff',2)

    # img = cv2.imread('/media/yusheng/G/rgbd/rgb_0060.jpg')
    # depth = cv2.imread('/media/yusheng/G/rgbd/depth_0060.png',2)
    
    img = cv2.imread('/home/yusheng/jacquard/61cdd656fd957a55391e4d6c585a697a/1_61cdd656fd957a55391e4d6c585a697a_RGB.png')
    depth = cv2.imread('/home/yusheng/jacquard/61cdd656fd957a55391e4d6c585a697a/1_61cdd656fd957a55391e4d6c585a697a_perfect_depth.tiff',2)
