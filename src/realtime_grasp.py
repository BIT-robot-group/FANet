...
def run(opt, pipeline, align, depth_scale):
    ...
    while True:
        ...
        KpsToGrasppose(ret, img, depth_raw,  M_BL, cameraMatrix)
        
        # cv2.imwrite('{}.png'.format(str(i)),img)
...
if __name__ == '__main__':
    ...
    run(opt, pipeline, align, depth_scale)